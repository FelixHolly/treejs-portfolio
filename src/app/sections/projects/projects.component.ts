...
export class ProjectsComponent implements AfterViewInit, OnDestroy {
    ...
    private animate = () => {
        ...
        if (this.isRotating && this.model) {
            ...
            this.model.rotation.y = this.rotationStart + (this.rotationEnd - this.rotationStart) * easedT;
    ...
    private updateTexture(): void {
        ...
        const texture = this.textureLoader.load(this.currentProject.texture, () => {
            ...
            const oldMaterial = this.screenMesh!.material as THREE.Material | THREE.Material[];
